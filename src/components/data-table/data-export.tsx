...
export function DataTableExport<TData extends ExportableData>({
  ...
  const handleExportParents = async (type: "csv" | "excel") => {
    ...
    try {
      ...
      toast.error(t("dataTable.exportFailed"), { id: "export-parents-toast" });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleExportSubrows = async (type: "csv" | "excel") => {
    ...
    try {
      ...
      toast.error(t("dataTable.exportFailed"), { id: "export-subrows-toast" });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const exportAllPages = async (type: "csv" | "excel") => {
    ...
    try {
      ...
      if (success) {
        toast.success(t("dataTable.exportSuccess"), {

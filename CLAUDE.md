...
- C5 гар уншигч: browser + keyboard-wedge горимоор ажиллаж байгаа. Native апп (github War0maN/EpcBarcodeApp, локал `~/Projects/EpcBarcodeApp`): Ү5 эхний хэсэг (нэвтрэлт + хүлээн авалт + idempotent илгээлт, supabase-kt 3.5.0) `feature/supabase` branch дээр — C5 туршилт хүлээгдэж байна, master-т нэгтгээгүй.

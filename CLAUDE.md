...
- Native апп (github War0maN/EpcBarcodeApp, локал `~/Projects/EpcBarcodeApp`, supabase-kt 3.5.0): Ү5 хүлээн авалт **бодит агуулахад туршигдаж баталгаажсан** (2026-07-30, 169/172 таг), Ү6 тооллогын дэлгэц мөн C5 дээр ажиллаж байгаа — бүгд `feature/supabase` branch дээр, master-т нэгтгээгүй. Тулгалтын нормчлол = MatchEngine.key() (GTIN-14, сервертэй ижил); Compose-д дэвсгэр = үргэлж Surface (background() нь LocalContentColor шинэчилдэггүй). Зорилго (2026-07-30 тохирсон): бүх хөдөлгөөнийг mobile-оос хийдэг болгох — дараагийн шат = шилжүүлэг/актлалт (серверт ноорог-сагс), дараа нь борлуулалт/буцаалт.

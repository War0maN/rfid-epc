...
> ⚠️ **Түүхэн баримт** — энэ бол төслийн анхны (Phase 0) спек. Систем үүнээс хойш салбар,
> төлөвийн мөчлөг, гүйлгээ, үлдэгдэл, тайлан, эрхийн систем зэргээр өргөжсөн.
> Одоогийн бүрэн тайлбар: [architecture.md](architecture.md) · хэрэглээ: [user-guide.md](user-guide.md).

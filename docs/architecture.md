...
таарна. Вебийн UI (2026-08-04): тооллогын дэлгэрэнгүйн "Тоологдсон" картанд
"Уншигч апп: N · Вебээс: M" задаргаа — Вебээс > 0 бол шар chip (гараар
шивсэн байж болзошгүйн дохио), hover дээр тайлбар.
...
**Шат 2 — Шилжүүлэг/Актлалт мобайлоос ✅ (2026-08-05, талбайд туршигдсан):**
Сервер талын ноорог-сагс: `tx_drafts`/`tx_draft_items`/`tx_draft_lines` + 8 RPC
— уншсан таг серверт шууд сагслагдана (апп унтарсан ч алдагдахгүй), "Гүйлгээ
болгох" = `submit_tx_draft` → `create_transaction` (TRF/ADJ дугаар, падаан,
түүх, хүлээн авалт бүгд ердийн замаар — нэг л гүйлгээний систем). Гурван үүд:
(1) вебийн Даалгавар дэд таб — эх/очих салбар + бараа×тоо (Үлдэгдлээс cap-тай
эсвэл Бүх бараанаас), явцын хяналт; (2) уншигчийн даалгаврын горим — мөр бүр
амьд x/N (SGTIN→GTIN-14, GID→object_class локал тулгалт), жагсаалтад байхгүй/
тоо гүйцсэн таг сагсанд ОРОХГҮЙ, дутуу submit-д ⚠ баталгаажуулалт; (3)
уншигчийн чөлөөт сагс (жагсаалтгүй, газар дээрх шуурхай шилжүүлэг/актлалт).
Даалгаврыг from_branch-д хандах эрхтэй хэн ч гүйцэтгэнэ (RLS өргөссөн).

**Шат 3 — Борлуулалт/Буцаалт ✅ код бүрэн (2026-08-05, талбайн туршилт
хүлээгдэж байна):** ноорог-сагсны төрөлд sale/return нэмэгдсэн — Борлуулалт🛒/
Буцаалт↩️ нүд ижил overlay-гаар; буцаалтын сагсанд Борлуулсан/Актлагдсан таг л
орно (scan/prune төлөв төрлөөс хамаарна, вебийн statusesFor-той ижил); submit =
SAL/RTN гүйлгээ. Excel-ээс даалгаврын жагсаалт ✅ (importJobLines — бараа
үүсгэхгүй, GTIN→SKU→нэрээр тулгана).

**Тооллогын mobile UX (2026-08-05):** Тооллого нүд = 3 карттай цэс: Эхлүүлэх
(вебтэй ижил — салбар+тэмдэглэл, create_stocktake, үүсмэгц шууд идэвхжинэ) /
Нээлттэй ажлууд / Түүх (хаагдсан 30 — дотор нь хүрээтэй Тоологдсон/Дутуу/Илүү,
Дутуу▸=бараа×ширхэг, Илүү▸=скан үеийн ХӨЛДСӨН төлөв/салбартай жагсаалт; таг
бүрийн snapshot татахгүй тул гацахгүй). Идэвхтэй тооллогын "Илүү" = серверийн
not_expected ангилал (бүртгэлгүй unknown огт харагдахгүй). Навигаци/товчны
дүрэм: толгойд ганц товч (цэсэнд Хаах, дэд дэлгэцэд Буцах — нэг алхам), refresh
= ↻ тэмдэг мөрийн ард, бүх товч нэг өндөр — бүх overlay-д ижил. Олох: гох
дарахад эхэлж/зогсоно; уншигч алдагдсаны дараах сэргээлт Олоход ч ажиллана.

Үлдсэн: Шат 3-ын талбайн туршилт, офлайн буфер/retry, хүлээн авалтын дутууд
Олох хуулах.
